...
class Preferences(Gtk.Dialog):
    ...
    AUTOSTART_PATH = '{}/.config/autostart/indicator-nauta.desktop' \
        .format(os.getenv("HOME"))
    DESKTOP_PATH = '/usr/share/applications/indicator-nauta.desktop'
    sensors_regex = re.compile("{.+?}")

    SETTINGS_FILE = os.getenv("HOME") + '/.cache/indicator-nauta/preferences.json'
    settings = {}
    ...
    def _create_content(self):
        ...
        version_label.set_label(_('This is indicator-nauta version: {}').format(VERSION))
