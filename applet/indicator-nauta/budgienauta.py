...
class BudgieNauta(GObject.Object, Budgie.Plugin):
    ...
    def do_get_panel_widget(self, uuid):
        ...
        """
        return BudgieNautaApplet(uuid)

class BudgieNautaApplet(Budgie.Applet):
